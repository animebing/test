...
// repeated int32 shape = 4;
inline int helloworld::shape_size() const {
  return shape_.size();
}
inline void helloworld::clear_shape() {
  shape_.Clear();
}
inline ::google::protobuf::int32 helloworld::shape(int index) const {
  // @@protoc_insertion_point(field_get:lm.helloworld.shape)
  return shape_.Get(index);
}
inline void helloworld::set_shape(int index, ::google::protobuf::int32 value) {
  shape_.Set(index, value);
  // @@protoc_insertion_point(field_set:lm.helloworld.shape)
}
inline void helloworld::add_shape(::google::protobuf::int32 value) {
  shape_.Add(value);
  // @@protoc_insertion_point(field_add:lm.helloworld.shape)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
helloworld::shape() const {
  // @@protoc_insertion_point(field_list:lm.helloworld.shape)
  return shape_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
helloworld::mutable_shape() {
  // @@protoc_insertion_point(field_mutable_list:lm.helloworld.shape)
  return &shape_;
}
