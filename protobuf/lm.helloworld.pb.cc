...
void protobuf_AssignDesc_lm_2ehelloworld_2eproto() {
  ...
  static const int helloworld_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(helloworld, shape_),
  };
...
void protobuf_AddDesc_lm_2ehelloworld_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\023lm.helloworld.proto\022\002lm\"A\n\nhelloworld\022"
    "\n\n\002id\030\001 \002(\005\022\013\n\003str\030\002 \002(\t\022\013\n\003opt\030\003 \001(\005\022\r\n"
    "\005shape\030\004 \003(\005", 92);
...
const int helloworld::kShapeFieldNumber;
#endif  // !_MSC_VER
...
::google::protobuf::uint8* helloworld::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->shape_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(4, this->shape(i), target);
  }
